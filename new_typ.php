        ...
        <div class="container-fluid p-4 text-center">
            ...
            if ($session) {
                ...
                <div style="background-color: white">
                    <form method="POST" class="needs-validation" novalidate action="add_typ.php"
                          enctype="multipart/form-data">
                        <h2>Nowy typ</h2>
                        <div style="padding: 20px 25%">
                            <label for="lastName" class="form-label">Nazwa typu</label>
                            <input type="text" class="form-control" name="nazwaTypu" id="nazwaTypu"
                        ...
                        ?>
                        <button class="w-40 btn btn-success btn-lg p-12" type="submit">Stwórz nowy typ
                        </button>
                    </form>
                </div>
                <?php
