            ...
            <div class="col-md-7">
                ...
                <form method="POST" class="needs-validation" novalidate action="create_account.php"
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <label for="avatar" class="form-label">Zdjęcie pracownika:</label>
                        ...
                        <div class="col-6">
                            <input type="text" class="form-control" name="x" id="x" placeholder="Pozycja X" value=""
                                   required>
                        </div>
                        <div class="col-6">
                            <input type="text" class="form-control" name="y" id="y" placeholder="Pozycja Y" value=""
                                   required>
                        </div>
